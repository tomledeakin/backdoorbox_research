...
#SBATCH --output=cifar10_scripts/cifar10_clean_label_output.log # Output file
#SBATCH --error=cifar10_scripts/cifar10_clean_label_error.log   # Error file
...
python visualize.py -method=pca -dataset=cifar10 -poison_type=clean_label -poison_rate=0.01
python visualize.py -method=tsne -dataset=cifar10 -poison_type=clean_label -poison_rate=0.01
python visualize.py -method=oracle -dataset=cifar10 -poison_type=clean_label -poison_rate=0.01

# Step 5: Apply IBD_PSC defense method
echo "Applying IBD_PSC defense method..."
python other_defense.py -defense=IBD_PSC -dataset=cifar10 -poison_type=clean_label -poison_rate=0.01
