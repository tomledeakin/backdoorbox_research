...
methods=("pca" "tsne" "umap" "oracle" "mean_diff" "SS" "isomap" "lle" "kpca" "spectral")
for method in "\${methods[@]}"; do
    echo "Using method: \$method"
    python visualize.py -method=\$method -dataset=$dataset -poison_type=$attack -poison_rate=0.01
done
