...
#SBATCH --output=gtsrb_scripts/gtsrb_adaptive_patch_output.log  # Output file
#SBATCH --error=gtsrb_scripts/gtsrb_adaptive_patch_error.log    # Error file
...
python visualize.py -method=pca -dataset=gtsrb -poison_type=adaptive_patch -poison_rate=0.01
python visualize.py -method=tsne -dataset=gtsrb -poison_type=adaptive_patch -poison_rate=0.01
python visualize.py -method=oracle -dataset=gtsrb -poison_type=adaptive_patch -poison_rate=0.01

# Step 5: Apply IBD_PSC defense method
echo "Applying IBD_PSC defense method..."
python other_defense.py -defense=IBD_PSC -dataset=gtsrb -poison_type=adaptive_patch -poison_rate=0.01
