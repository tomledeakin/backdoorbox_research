...
#SBATCH --output=gtsrb_scripts/gtsrb_blend_output.log  # Output file
#SBATCH --error=gtsrb_scripts/gtsrb_blend_error.log    # Error file
...
echo "Creating poisoned training set for blend on GTSRB..."
...
python test_model.py -dataset=gtsrb -poison_type=blend -poison_rate=0.01

# Step 4: Visualize the model's latent space with PCA, TSNE, and Oracle
echo "Visualizing the model's latent space..."
python visualize.py -method=pca -dataset=gtsrb -poison_type=blend -poison_rate=0.01
python visualize.py -method=tsne -dataset=gtsrb -poison_type=blend -poison_rate=0.01
python visualize.py -method=oracle -dataset=gtsrb -poison_type=blend -poison_rate=0.01

# Step 5: Apply IBD_PSC defense method
echo "Applying IBD_PSC defense method..."
python other_defense.py -defense=IBD_PSC -dataset=gtsrb -poison_type=blend -poison_rate=0.01

echo "Experiment for GTSRB with blend completed."
