...
#SBATCH --output=umap_scripts/cifar10_blend_output.log   # Output file
#SBATCH --error=umap_scripts/cifar10_blend_error.log     # Error file
...
for method in "${methods[@]}"; do
    ...
    python umap_visualize.py -method=$method -dataset=cifar10 -poison_type=blend -poison_rate=0.01
done
