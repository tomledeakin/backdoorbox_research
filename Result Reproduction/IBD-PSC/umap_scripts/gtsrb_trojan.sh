...
#SBATCH --output=umap_scripts/gtsrb_trojan_output.log   # Output file
#SBATCH --error=umap_scripts/gtsrb_trojan_error.log     # Error file
...
for method in "${methods[@]}"; do
    ...
    python umap_visualize.py -method=$method -dataset=gtsrb -poison_type=trojan -poison_rate=0.01
done
